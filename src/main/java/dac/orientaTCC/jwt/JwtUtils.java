...
public class JwtUtils {
    ...
    public static JwtToken createToken(String email, String role){
        ...
        String token = Jwts.builder()
                ...
                .setSubject(email)         //é interessante usar ou o id ou email no subject, porque ele é usado para confirmar se o token é de um usuario existente na aplicação, o valor do subject é usado para fazer a consulta no banco
                ...
                .claim("role", role)   //pode ser usado para definir o tipo do perfil de usuario
    ...
    private static Claims getClaimsFromToken(String token){
        ...
        return null; //pq se o metodo cair no catch ele faz as coisa do catch e por isso retorna null
    }
